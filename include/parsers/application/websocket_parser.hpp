 ...
 * - 跨平台兼容
 */
class WebSocketParser : public Core::BaseParser {
public:
    /**
     * @brief 构造函数
     */
     ...
     */
    bool is_websocket_handshake(const ProtocolParser::Core::BufferView& buffer) const;
     ...
     */
    bool is_websocket_frame(const ProtocolParser::Core::BufferView& buffer) const;
     ...
     * @return 解析结果
     */
    ParseResult parse_handshake(const ProtocolParser::Core::BufferView& buffer, 
     ...
     * @return 解析结果
     */
    ParseResult parse_frame(const ProtocolParser::Core::BufferView& buffer, 
...
private:
     ...
     * @return 使用的字节数
     */
    size_t parse_payload_length(const ProtocolParser::Core::BufferView& buffer, 
...
} // namespace ProtocolParser::Application#pragma once
